...
public abstract class FileBasedTest {
	 ...
	 * 
	 * @param testFile
	 * @param elementSeparatorChar
	 *            separator of the elements within the same line
	 * @param commentLineChar
	 *            character that identifies a commented line
	 */
	 ...
	 * @param elements
	 * @param lineNumber
	 *            number or the line (starting at 1) including the commented lines
	 */
