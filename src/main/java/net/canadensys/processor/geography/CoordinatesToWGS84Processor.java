...
public class CoordinatesToWGS84Processor extends AbstractDataProcessor {
	 ...
	 * @param sourceCoordinateSystem e.g. EPSG:26918
	 * @throws UnsupportedOperationException if the provided sourceCoordinateSystem is not supported
	 */
	...
	public CoordinatesToWGS84Processor(String sourceCoordinateSystem, String xCoordinateInName, String yCoordinateInName,
			String latitudeOutName, String longitudeOutName) throws UnsupportedOperationException{
		try {
